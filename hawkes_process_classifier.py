...
class hawkes_process_classifier:
    ...
    def neg_log_likelihood(self, param, *triplet):
        ...
        first_sum = (alpha * 1.0 / max(1e-10, w) )* np.sum(time_exp)
    ...
    # def wrapper_gradient_mu(self, param, *triplet):
    #
    #     mu = param
    #
    #     del_mu = self.gradient_mu(mu, *triplet)
    #     return np.exp(del_mu)
    ...
    def gradient_mu(self, param, *triplet):
        ...
        print("Negative of gradient: ", -del_mu)
    ...
    def check_grad_mu(self, time_stamps):
        ...
        for i in range(100):
            ...
            print("Mu: ", mu, "Err: ", check_grad(self.neg_log_likelihood, self.gradient_mu, np.array([mu]), *triplet))
    ...
    def main(self):
        res = self.estimate_params(np.array([2.8914986, 8.09118015, 10.35220284, 15.72422933,
        ...
        print("Estimated mu: ", np.exp(res.x))
